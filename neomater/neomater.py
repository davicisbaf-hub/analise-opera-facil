...
def analisar_neomater():
    arquivo = "ralatorio_prestador/Neomater/neomater.xlsx"
    ...
    for municipio in municipios:
        try:
            ...
            if resultados:
                ...
                df.to_excel(f"./neomater/resultado/{coluna_procedimento}.xlsx", index=False)
            ...
            if procedimentos_nao_mapeados:
                ...
                df.to_excel(f"./neomater/resultado/Nao-listados_{coluna_procedimento}.xlsx", index=False)
