...
def analisar_prontobaby():
    arquivo = "ralatorio_prestador/Prontobaby/prontobaby.xlsx"
    municipios = ["Belford Roxo", "Duque de Caxias","Itaguai", "Japeri", "Mage", "Mesquita", "Nilopolis", "Nova Iguacu", "Paracambi", "Queimados", "Seropedica", "Sao Joao de Meriti"]
    ...
    for municipio in municipios:
        try:
            ...
            if resultados:
                ...
                df.to_excel(f"./prontobaby/resultado/{coluna_procedimento}.xlsx", index=False)
            ...
            if procedimentos_nao_mapeados:
                ...
                df.to_excel(f"./prontobaby/resultado/Nao-listados_{coluna_procedimento}.xlsx", index=False)
