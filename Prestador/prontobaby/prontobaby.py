...
def analisar_prontobaby():
    arquivo = Path("../relatorios_simplificados/separarPediatrico_SIMPLIFICADO.xlsx").resolve(strict=False)
    ...
    if resultados_por_municipio: 
        ...
        # Salvar em Excel
        df_consolidado.to_excel("../Prestador/prontobaby/resultado/TODOS_MUNICIPIOS_CONSOLIDADO.xlsx")
    ...
    if nao_listados_dfs:
        ...
        df_nao_listados_consolidado.to_excel("../Prestador/prontobaby/resultado/PROCEDIMENTOS_NAO_LISTADOS_CONSOLIDADO.xlsx", index=False)
