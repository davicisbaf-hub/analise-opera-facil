    ...
    for municipio in municipios:
        try:
            ...
            if resultados:
                ...
                df.to_excel(f"Prestador/neotin/resultado/{coluna_procedimento}.xlsx", index=False)
            ...
            if procedimentos_nao_mapeados:
                ...
                df.to_excel(f"Prestador/neotin/resultado/Nao-listados_{coluna_procedimento}.xlsx", index=False)
