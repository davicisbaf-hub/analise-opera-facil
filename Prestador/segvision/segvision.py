...
def analisar_segvision():
    arquivo = "ralatorio_prestador/segvision.xlsx"
    ...
    for municipio in municipios:
        try:
            ...
            if resultados:
                ...
                df.to_excel(f"./segvision/resultado/{coluna_procedimento}.xlsx", index=False)
            ...
            if procedimentos_nao_mapeados:
                ...
                df.to_excel(f"./segvision/resultado/Nao-listados_{coluna_procedimento}.xlsx", index=False)
